            ...
            <div className="container relative" ref={parallaxRef}>
                <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]">
                    <h1 className="h1 mb-6 "> Explore The Possibilities of&nbsp;AI&nbsp;Chatting With {` `}
                        <span className="inline-block relative"> Brainwave {" "} <img src={curve} className="absolute top-full left-0 w-full xl:-ml-2"
                            width={624}
                            height={28}
                            alt="curv"
                        /></span>
                    </h1>
                    <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8"> unlock your power with the brainwave AI you will experience like never before , it will absolutely transform your buisness</p>
                    ...
                    <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient ">
                        <div className="relative bg-n-8 rounded-[1rem]">
                            ...
                            <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                                ...
                                <Generating className="absolute left-4 bottom-5 right-4 md:left-1/2 md:right-auto md:bottom-8 md:w-[31rem] md:-translate-x-1/2 " />
